...
if ($branch) {
	...
	echo '<div class="page">
			<img src="../../upload/'.$coup_QrPath.'A4_'.str_pad($id,4,"0",STR_PAD_LEFT).'-'.str_pad($branch,4,"0",STR_PAD_LEFT).'.jpg" height="1120px" style="border:1px black solid;">
		</div>';
	...
	for($x=0; $x < $arrlength; $x++) {
		...
		echo '<div class="page">
				<img src="../../upload/'.$coup_QrPath.'A4_'.str_pad($id,4,"0",STR_PAD_LEFT).'-'.str_pad($branch[$x],4,"0",STR_PAD_LEFT).'.jpg" height="1120px" style="border:1px black solid;">
			</div>';
	}
}
