...
<form action="create_activity.php?brand='".$brand."'" method="post" enctype="multipart/form-data" name="frmMain">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<?php
						...
						$path_upload_activity = '../../upload/'.$brand.'/activity_upload/';
						$file_name = 'activity_'.$brand.'.jpg';
					...
					# ========================================================================================= #
						...
						echo "<img src=".$path_upload_activity.$file_name.">";

						imagesavealpha($images, true);
						ImageJPEG($images,$path_upload_activity.$file_name);
						ImageDestroy($images);
