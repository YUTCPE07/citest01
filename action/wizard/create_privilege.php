...
<form action="create_privilege.php?brand='".$brand."'" method="post" enctype="multipart/form-data" name="frmMain">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<?php
						...
						$path_upload_privilege = '../../upload/'.$brand.'/privilege_upload/';
						$file_name = 'privilege_'.$brand.'.jpg';
					...
					# ========================================================================================= #
						...
						echo "<img src=".$path_upload_privilege.$file_name.">";

						imagesavealpha($images, true);
						ImageJPEG($images,$path_upload_privilege.$file_name);
						ImageDestroy($images);
		...
		<td valign="top">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<div class="col-xs-8">
						<input type="text" class="form-control text-md" name="text-type" value="<?php if ($_REQUEST['text-type']) { echo $_REQUEST['text-type']; } else echo "PRIVILEGE"; ?>" onchange="this.form.submit()">
					</div>
					<br><br></td>
				</tr>
				<tr>
