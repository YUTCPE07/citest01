...
if ($_SESSION['role_action']['follow']['view'] != 1) {
...
$sql = 'SELECT
		...
		WHERE messages.mess_Type = "Follow"
...
while ($axRow = $oRes->FetchRow(DBI_ASSOC)){
	...
	if ($_SESSION['role_action']['follow']['edit'] == 1) {
		...
		$data_table .= '<td style="text-align:center"><span style="cursor:pointer" onclick="'."window.location.href='follow_create.php?act=edit&id=".$axRow['bran_BrandID']."'".'">
...
$oTmp->assign('content_file', 'message/follow.htm');
