...
if ($_SESSION['role_action']['birthday']['view'] != 1) {
...
$sql = 'SELECT
		...
		WHERE messages.mess_Type = "Birthday"
		'.$where_brand.' 
...
while ($axRow = $oRes->FetchRow(DBI_ASSOC)){
	...
	if ($_SESSION['role_action']['birthday']['edit'] == 1) {

		$data_table .= '<td style="text-align:center"><span style="cursor:pointer" onclick="'."window.location.href='birthday_create.php?act=edit&id=".$axRow['bran_BrandID']."'".'">
...
$oTmp->assign('is_menu', 'is_birthday_message');

$oTmp->assign('in_brand', 'in');

$oTmp->assign('sub_messages', 'in');

$oTmp->assign('content_file', 'message/birthday.htm');
