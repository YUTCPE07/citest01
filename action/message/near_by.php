...
if ($_SESSION['role_action']['near_by']['view'] != 1) {
...
$sql = 'SELECT
		...
		WHERE messages.mess_Type = "NearBy"
		'.$where_brand.' 
...
while ($axRow = $oRes->FetchRow(DBI_ASSOC)){
	...
	if ($_SESSION['role_action']['near_by']['edit'] == 1) {
		...
		$data_table .= '<td style="text-align:center"><span style="cursor:pointer" onclick="'."window.location.href='near_by_create.php?act=edit&id=".$axRow['bran_BrandID']."'".'">
...
$oTmp->assign('content_file', 'message/near_by.htm');
