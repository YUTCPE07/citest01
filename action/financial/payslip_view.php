      ...
      while ($axRow_payslip = $payslip->fetch(PDO::FETCH_ASSOC)){
        ...
        while ($axRow_invoice = $oRes->fetch(PDO::FETCH_ASSOC)){
          ...
          $data_payslip .= '<tr>
                            ...
                            <td style="border:1px solid #D2D2D2;" align="right">'.number_format($brand_amt,2).'&nbsp;&nbsp;</td>
                          </tr>';
        ...
        <td colspan="2" >
          <table width="100%"  style="border: 1px solid #D2D2D2;border-collapse:collapse;line-height: 25px;">
            ...
            <tr>
              ...
              <td style="border:1px solid #D2D2D2;" align="right">- 30.00 &nbsp;</td>
            </tr>
            <tr>
              <td style="border:1px solid #D2D2D2;" align="right" colspan="2"> &nbsp;รวมราคาทั้งสิ้น / Total &nbsp;</td>
              <td style="border:1px solid #D2D2D2;" align="right">'.number_format($total_amount-30,2).' &nbsp;</td>
            </tr>
            <tr>
...
?>
      ...
      <button type="button" style="cursor:pointer" class="btn btn-default btn-sm" onClick="openPrint('<?php echo $id; ?>')">Print</button>
...
<script type="text/javascript">
    ...
    function openPrint(id){
        ...
        var $payslip_id = id;
        var $url_data = 'payslip_print.php?payslip='+$payslip_id;
