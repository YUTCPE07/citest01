...
if ($_SESSION['role_action']['custom_card']['view'] != 1) {
...
$sql = 'SELECT 
		...
		WHERE custom_field.cufi_Type="Register"
		'.$where_brand.' 
...
if($Act == 'delete' && $id != '') {
	...
	if($axRow['cufi_Deleted']=='') {
 	...
 	echo '<script>window.location.href="custom_card.php";</script>';
	...
	while ($axRow = $oRes->FetchRow(DBI_ASSOC)){
		...
		if($axRow['logo_image']!=''){
			...
			$logo_view = '<img src="../../upload/'.$axRow['path_logo'].$axRow['logo_image'].'" class="image_border" width="120" height="120"/>';

		} else {

			$logo_brand = '<img src="../../images/400x400.png" class="image_border" width="60" height="60"/>';

			$logo_view = '<img src="../../images/400x400.png" class="image_border" width="120" height="120"/>';
		}

		if($axRow['brand_id']=='0'){

			$logo_brand = '<img src="../../images/mi_action_logo.png" class="image_border" width="60" height="60"/>';
			$logo_view = '<img src="../../images/mi_action_logo.png" class="image_border" width="120" height="120"/>';
		}
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
						        ...
						        <table width="70%" class="myPopup">
						        	...
						        	<td>
								        <p style="font-size:12px;padding-left:10px;">
								        	<b>"'.$axRow['cufi_Name'].'"</b><br>
								            By clicking the <b>"Inactive"</b> button to:<br>
								            &nbsp; &nbsp;- Inactive this Custom Field<br>
								        </p>
								    </td>
						        	</tr>
						        </table>
						    ...
						    <div class="modal-footer">
						    	<a href="custom_card.php?act=delete&id='.$axRow['cufi_CustomFieldID'].'">
		...
		if ($_SESSION['role_action']['custom_card']['edit'] == 1) {

			$data_table .=	'<td style="text-align:center">
							<a href="custom_card_create.php?act=edit&id='.$axRow['cufi_CustomFieldID'].'"><button type="button" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></button></a></td>';
		}

		if ($_SESSION['role_action']['custom_card']['delete'] == 1) {
...
$oTmp->assign('content_file', 'custom_form/custom_card.htm');
