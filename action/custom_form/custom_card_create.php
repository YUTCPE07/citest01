...
if (($_SESSION['role_action']['custom_card']['add'] != 1) || ($_SESSION['role_action']['custom_card']['edit'] != 1)) {
...
if( $Act == 'edit' && $id != '' ){
	...
	$sql_custom_field .= ',cufi_Type="Register"';   
...
$oTmp->assign('content_file', 'custom_form/custom_card_create.htm');
