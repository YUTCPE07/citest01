...
$sql_coupon = "SELECT 
					member_coupon_trans.meco_CreatedDate AS date_use,
					...
					WHERE member_coupon_trans.coup_CouponID = ".$id."
					".$where_branch."
...
$check_coupon = $oDB->QueryOne($sql_coupon);

if ($check_coupon) {

	$table_coupon = "<table id='example' class='table table-bordered' style='background-color:white;'>
	...
	while ($axRow = $oRes_coupon->FetchRow(DBI_ASSOC)) {
...
$oTmp->assign('content_file', 'analytics/last_coupon.htm');
