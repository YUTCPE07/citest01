...
while ($axRow_card_member = $oRes_card_member->FetchRow(DBI_ASSOC)){
	...
	if ($axRow_card_member['member_card_code'] == '') { $axRow_card_member['member_card_code'] = '-'; }


	$table_member .= '<table class="myPopup">
						<tr>
							<td rowspan="5" width="200px" valign="top" style="text-align:center;">
						...
						<tr>
							<td style="text-align:right"><b>Member Card ID</b></td>
							<td style="text-align:center;"><b>:</b></td>
							<td><b>'.$axRow_card_member['member_card_code'].'</b></td></tr>';
...
$oTmp->assign('content_file', 'analytics/top_member.htm');
