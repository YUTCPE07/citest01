	...
	while($axRow = $rs_trans->FetchRow(DBI_ASSOC)) {
		...
		if ($axRow['rewa_Type'] == 'Card') {
			...
			if($axRow_card['image']!=''){
				...
				$axRow['reward_image'] = '<img src="../../upload/'.$axRow_card['path_image'].$axRow_card['image'].'" class="img-rounded image_border" width="50"/>';
				...
				$axRow['reward_image'] = '<img src="../../upload/'.$axRow_card['path_image'].$axRow_card['image_newupload'].'" class="img-rounded image_border" width="50"/>';

			} else {

				$reward_image = '<img src="../../images/400x400.png" class="img-rounded image_border" height="100"/>';

				$axRow['reward_image'] = '<img src="../../images/400x400.png" class="img-rounded image_border" width="50"/>';
			}
		...
		$data_table .= '<tr>
							...
							<td style="text-align:center">'.$axRow['retr_Platform'].'</td>
							<td style="text-align:center">'.DateTime($axRow['update_date']).'</td>
...
$oTmp->assign('content_file','member_insights/member_redeem.htm');
