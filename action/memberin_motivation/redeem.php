...
if($Act == 'active' && $id != '') {
	...
	while ($axRow = $oRes->FetchRow(DBI_ASSOC)){
		...
		# VIEW
			...
			if ($axRow['rera_HomeAddress'] == 'T') {

				$axRow['rera_HomeAddress'] = '<span class="glyphicon glyphicon-check"></span>';
			
			} else { $axRow['rera_HomeAddress'] = '<span class="glyphicon glyphicon-unchecked"></span>'; }

			if ($axRow['rera_BankAccount'] == 'T') {

				$axRow['rera_BankAccount'] = '<span class="glyphicon glyphicon-check"></span>';
			
			} else { $axRow['rera_BankAccount'] = '<span class="glyphicon glyphicon-unchecked"></span>'; }

			if ($axRow['rera_Email'] == 'T') {

				$axRow['rera_Email'] = '<span class="glyphicon glyphicon-check"></span>';
			
			} else { $axRow['rera_Email'] = '<span class="glyphicon glyphicon-unchecked"></span>'; }

			if ($axRow['rera_Mobile'] == 'T') {

				$axRow['rera_Mobile'] = '<span class="glyphicon glyphicon-check"></span>';
			
			} else { $axRow['rera_Mobile'] = '<span class="glyphicon glyphicon-unchecked"></span>'; }
						    ...
						    <div class="modal-body" align="left">
						        ...
						        <center>
					                ...
					                <ul id="tapMenu" class="nav nav-tabs">
					                    ...
					                    <li>
					                    	<a data-toggle="tab" href="#info'.$axRow['rede_RewardRedeemID'].'">
					                ...
					                <div class="tab-content">
					                    ...
					                    <div id="info'.$axRow['rede_RewardRedeemID'].'" class="tab-pane"><br>
					                    	<table width="80%" class="myPopup">
								        		<tr>
								        			<td style="text-align:right" width="45%">
								        				'.$axRow['rera_HomeAddress'].'</td>
								        			<td style="text-align:center" width="5%"></td>
								        			<td>Home Address</td>
								        		</tr>
								        		<tr>
								        			<td style="text-align:right">
								        				'.$axRow['rera_BankAccount'].'</td>
								        			<td style="text-align:center"></td>
								        			<td>Bank Account</td>
								        		</tr>
								        		<tr>
...
$oTmp->assign('content_file', 'memberin_motivation/redeem.htm');
