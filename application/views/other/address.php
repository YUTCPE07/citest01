...
<div class="container mt-5 h4 light text-gray1">
	...
	<div class="mb-5">
		<div class="row">
			<div class="col-md-12 col-lg-12">
				<div class="h4 bold text-black">ที่อยู่</div>
	...
	<div class="mb-5 row">
		<div class="col-md-12 col-lg-12">
            ...
            <div class="d-inline-block py-1 px-2" >ID Line: @memberin </div>
            <div class="d-inline-block py-1 px-2" >หรือ เเสกน</div>
            <div class="qrCodeLine d-md-inline-block d-none">
	            <img class="" src="<?php echo base_url('assets/images/template/footer/QR_code.jpg'); ?>">
	        </div>
	        <div class="d-md-none d-inline-block w-25">
	            <img class="" src="<?php echo base_url('assets/images/template/footer/QR_code.jpg'); ?>">
	        </div>
        </div>
	</div>
